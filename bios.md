...
<div class="grid grid-md-2">
  {% for i in (0..3) %}
    <div><img src="img/{{ site.data.Executive[i].netid }}.jpg" align="left" hspace="20" vspace="30" id="myImage">
...
<div class="grid grid-md-2">
  {% for i in (0..15) %}
    <div><img src="img/{{ site.data.Director[i].netid }}.jpg" align="left" hspace="20" vspace="30" id="myImage">
...
<div class="grid grid-md-2">
  {% for i in (0..9) %}
    <div><img src="img/{{ site.data.jrDirector[i].netid }}.jpg" align="left" hspace="20" vspace="30" id="myImage">
...
<div class="grid grid-md-2">
  {% for i in (0..10) %}
    <div><img src="img/{{ site.data.Chair[i].netid }}.jpg" align="left" hspace="20" vspace="30" id="myImage">
