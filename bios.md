...
<div class="grid grid-md-4">
  {% for i in (0..3) %}
    <div><img class="image-circle" src="img/{{ site.data.Executive[i].netid }}.jpg" hspace="20" vspace="30" id="myImage" loading="lazy" height="1200" width="1200">
...
<div class="grid grid-md-4">
  {% for i in (0..9) %}
    <div><img class="image-circle" src="img/{{ site.data.Director[i].netid }}.jpg" hspace="20" vspace="30" id="myImage" loading="lazy" height="1200" width="1200">
...
<div class="grid grid-md-4">
  {% for i in (0..8) %}
    <div><img class="image-circle" src="img/{{ site.data.jrDirector[i].netid }}.jpg" hspace="20" vspace="30" id="myImage" loading="lazy" height="1200" width="1200">
...
<div class="grid grid-md-4">
  {% for i in (0..10) %}
    <div><img class="image-circle" src="img/{{ site.data.Chair[i].netid }}.jpg" hspace="20" vspace="30" id="myImage" loading="lazy" height="1200" width="1200">
